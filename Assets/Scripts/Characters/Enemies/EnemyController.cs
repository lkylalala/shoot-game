...
public class EnemyController : MonoBehaviour
{
    ...
    [SerializeField] protected float minFireInerval;
   ...
   IEnumerator RandomlyMovingCoroutine()
   {
       ...
       {
           //如果敌人的位置没有达到目标的话，就让它继续移动，否则选定一个新的随机目标位置
   ...
   protected virtual IEnumerator RandomlyFireCoroutine()
   {
       while(gameObject.activeSelf)
       {
           yield return new WaitForSeconds(Random.Range(minFireInerval, maxFireInterval));
